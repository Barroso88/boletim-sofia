              ...
              <table className="premium-table">
                ...
                <tbody>
                  {processedRegistos.map((registo, index) => {
                    ...
                    return (
                      <tr key={registo.id} className="neon-row-peso animate-fade-in" style={{ animationDelay: `${index * 0.04}s` }}>
                        <td>
              ...
              <table className="premium-table">
                ...
                <tbody>
                  {processedAlturas.map((registo, index) => {
                    ...
                    return (
                      <tr key={registo.id} className="neon-row-altura animate-fade-in" style={{ animationDelay: `${index * 0.04}s` }}>
                        <td>
                          <div className="td-date">{format(dateObj, "dd/MM/yyyy")}</div>
                        </td>
                        <td>
