  ...
  return (
    <div className="dashboard">
      ...
      <div className="ha-actions-grid" style={{ marginTop: '1.5rem' }}>
        <button className="ha-action-btn ha-neon" onClick={() => triggerHA('sala')}>
          <div className="ha-icon-wrapper">
            <img src={salaIcon} alt="Sala" className="custom-ha-icon" />
          </div>
          <span>Sala</span>
        </button>
        <button className="ha-action-btn ha-neon" onClick={() => triggerHA('quarto')}>
          <div className="ha-icon-wrapper">
            <img src={quartoIcon} alt="Quarto" className="custom-ha-icon" />
          </div>
          <span>Quarto</span>
        </button>
        <button className="ha-action-btn ha-neon" onClick={() => triggerHA('quarto-sofia')}>
          <div className="ha-icon-wrapper">
            <img src={sofiaIcon} alt="Quarto Sofia" className="custom-ha-icon" />
          </div>
          <span>Quarto Sofia</span>
        </button>
        <button className="ha-action-btn ha-neon" onClick={() => triggerHA('fralda')}>
          <div className="ha-icon-wrapper">
            <img src={diapersIcon} alt="Fralda" className="custom-ha-icon" />
          </div>
          <span>Fralda</span>
        </button>
        <button className="ha-action-btn ha-neon" onClick={() => triggerHA('persiana')}>
          <div className="ha-icon-wrapper">
            <img src={blindsIcon} alt="Persiana" className="custom-ha-icon" />
          </div>
          <span>Persiana</span>
        </button>
        <button className="ha-action-btn ha-neon" onClick={() => triggerHA('ventilador')}>
          <div className="ha-icon-wrapper">
